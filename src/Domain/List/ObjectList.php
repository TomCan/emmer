...
class ObjectList
{
    ...
    public function getNextMarker2(): string
    {
        return $this->nextMarker2;
    }

    public function setNextMarker2(string $nextMarker2): void
    {
        $this->nextMarker2 = $nextMarker2;
    }
}
